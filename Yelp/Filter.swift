...
struct Filter {
    ...
    var sort: YelpSortMode {
        didSet {
            ...
            Filter.sorts.values.forEach { (element) in
                if element != sortName{
    ...
    var otherSortOptions: Array<String>!

    var sortName: String {
        return Filter.sorts[sort]!
    }
    ...
    var radius: Float {
        didSet {
            ...
            Filter.radii.values.forEach { (element) in
                if element != formattedRadius {
                    options.append(element)
                }
            }
    ...
    var otherRadiiOtions: Array<String>!
    ...
    init(dictionary: Dictionary<String, Any>) {
        ...
        if let newValue = dictionary["dealsOnly"] as? Bool {
            dealsOnly = newValue
        } else {
            dealsOnly = false
        }

        if let newValue = dictionary["radius"] as? Float {
            radius = newValue
        } else {
            radius = 0
        }
    ...
    mutating func setDealsOnly(_ newValue: Bool) {
        dealsOnly = newValue
    }

    mutating func setRadius(_ newValue: Float) {
        radius = newValue
    }

    mutating func setSortType(_ newValue: YelpSortMode) {
        sort = newValue
    }
    ...
    func dictionaryRepresentation() -> Dictionary<String, Any> {
        ...
        dict.updateValue(dealsOnly, forKey: "dealsOnly")

        dict.updateValue(radius, forKey: "radius")
    ...
    static let radii: Dictionary<Float, String> = [0: "Auto", 0.3: "0.3 miles", 1: "1 mile", 5: "5 miles", 20: "20 miles"]
